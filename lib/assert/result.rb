...
module Assert::Result
  ...
  class Fail < Base
    ...
    def initialize(test_name, message_or_exception, backtrace=nil)
      if message_or_exception.kind_of?(TestFailure)
        super(test_name, message_or_exception.message, message_or_exception.backtrace || [])
        ...
        super(test_name, message_or_exception, backtrace)
      end
    end
  ...
  class Error < Base
    ...
    def initialize(test_name, exception)
      if exception.kind_of?(Exception)
        super(test_name, "#{exception.message} (#{exception.class.name})", exception.backtrace || [])
      else
